  ...
  return (
    <div className="p-8">
      ...
      <ul className="flex items-center w-80 h-10 mt-6 ml-6 border-2 rounded-lg">
        <li className='p-2 text-xl whitespace-no-wrap' onClick={() => setShowOverview(!showOverview)}>Overview</li>
        <li className='p-2 text-xl whitespace-no-wrap'>Table</li>
        <li className='p-2 text-xl whitespace-no-wrap'>List</li>
      ...
      {showOverview && (
          ...
          <div >
            <div className='flex items-center'>
            {/* first */}
            <div className='w-80 h-59 mt-6 ml-6 border-2 rounded-lg p-2 m-4 text-center'>
              <div className='w-12 h-59 mt-1 ml-1 border-2 rounded-lg'>
              ...
              <div className="absolute mb-7 ml-4">
                <p className="text-s ">Total Customer</p>
                <p className="text-l font-bold">2,420</p>
              </div>

              <div className="flex items-center w-18 h-58 mt-6 ml-48 border-2  rounded-full">
            ...
            <div className='w-80 h-58 mt-6 ml-6 border-2 rounded-lg p-2 m-4 text-center'>
              <div className='w-12 h-59 mt-2 ml-1 border-2 rounded-lg'>
              ...
              <div className="absolute mb-8 ml-4">
                <p className="text-s">Members</p>
                <p className="text-l font-bold">1,210</p>
              </div>

              <div className="flex items-center w-18 h-10 mt-6 ml-48 border-2 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 24 24" className="fill-none stroke-black stroke-linecap-round stroke-linejoin-round stroke-width-2">
            ...
            <div className="w-80 h-58 mt-6 ml-6 border-2 rounded-lg p-7 m-4 text-center">
              <div className='w-12 h-59 mt-2 ml-1 border-2 rounded-lg'>
              ...
              <div class="absolute mb-0 ml-0 mt-4">
                <p className="text-s">Active now</p>
                <p className="text-xl font-bold">316</p>
              </div>
            </div>
            </div>
            {/* mid-dash-board */}
            ...
            <div className='flex items-center justify-end'>
              <input type="text" placeholder="Search..." className="border border-gray-300 p-1 rounded"/>
              <div className='flex items-center'>
                <button className="flex items-center bg-white hover:bg-gray-500 text-black font-bold py-2 px-4 rounded">
            ...
            <div className='flex items-center border p-1 w-18 h-10'>
              ...
              <p>Jan 1-Jan 30</p>
              <svg xmlns="http://www.w3.org/2000/svg" width="19" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="m6.4 18.308l-.708-.708l5.6-5.6l-5.6-5.6l.708-.708l5.6 5.6l5.6-5.6l.708.708l-5.6 5.6l5.6 5.6l-.708.708l-5.6-5.6z"/></svg>
            </div>
            <div className='flex items-center border p-1 w-18 h-10'>
              <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 256 256">
                <path fill="green" d="M144 128a16 16 0 1 1-16-16a16 16 0 0 1 16 16"/>
