  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <div className="flex items-center justify-between p-[10px]">
        <button className="text-xl mb-2" onClick={() => setShowLogIn('LogIn')}>Login</button>
        <button className="text-xl mb-2 mx-4" onClick={() => setShowLogIn('Register')}>Signup</button>
      </div>
      {showLogIn==='LogIn' && (
      <div className="mb-8">
        ...
        <button type='submit' className='bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-700'>
          LOGIN
        </button>
        </form>
      </div>
      ...
      {showLogIn ==='Register' &&
        <form autoComplete='off' className='w-64' onSubmit={signup}>
        <div className="mb-4">
